...
import 'package:gdsc_bloc/utilities/Widgets/admin_reports_card.dart';
...
class AppReports extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => AppFunctionsCubit()..getReports(),
        ...
        return Scaffold(
          ...
          body: SingleChildScrollView(
            child: RefreshIndicator(
              onRefresh: () async {
                BlocProvider.of<AppFunctionsCubit>(context).getReports();
              },
              child: Padding(
