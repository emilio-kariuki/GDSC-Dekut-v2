...
import '../../../../utilities/Widgets/admin_twitter_card.dart';
...
class AppSpaces extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (context) => EventBloc()..add(GetSpaces()),
        ),
        BlocProvider(
      ...
      child: Builder(builder: (context) {
        return Scaffold(
          ...
          body: RefreshIndicator(
            onRefresh: () {
              BlocProvider.of<EventBloc>(context).add(const GetAllResource());
              return Future.value();
            },
                  ...
                  children: [
                    ...
                    BlocListener<EventBloc, EventState>(
                      listener: (context, state) {
                        if (state is SearchTwitterFailure) {
                          Timer(
                      ...
                      child: BlocBuilder<EventBloc, EventState>(
                        builder: (context, state) {
                          if (state is SearchTwitterLoading) {
                            return SizedBox(
                              height: height * 0.65,
                              child: const Center(
                                child: LoadingCircle(),
                          ...
                          } else if (state is SearchTwitterSuccess) {
                            return Column(
                              children: [
                                Row(
                                  mainAxisAlignment:
                                    ...
                                    : Padding(
                                        ...
                                        child: BlocConsumer<AppFunctionsCubit,
                                          ...
                                          listener: (context, appState) {
                                            if (appState is FetchSpaceSuccess) {
                                              idController.text =
                                                  appState.space.id!;
                                ...
                                builder: (context, state) {
                                  if (state is TwitterLoading) {
                                    return SizedBox(
                                        ...
                                        child: const Center(
                                            child: LoadingCircle()));
                                  } else if (state is TwitterSuccess) {
                                    return Padding(
                                      padding: const EdgeInsets.only(top: 10),
                                      child: BlocConsumer<AppFunctionsCubit,
                                          AppFunctionsState>(
