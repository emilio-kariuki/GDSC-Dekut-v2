...
import 'package:gdsc_bloc/utilities/Widgets/admin_resource_card.dart';
import 'package:gdsc_bloc/utilities/Widgets/loading_circle.dart';
import 'package:gdsc_bloc/utilities/image_urls.dart';
import 'package:gdsc_bloc/views/profile/Admin/Resources/edit_resource_dialog.dart';
...
class AppResources extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (context) => EventBloc()..add(const GetAllResource()),
        ),
        BlocProvider(
