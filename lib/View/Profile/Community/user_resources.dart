...
class UserResources extends StatelessWidget {
            ...
            return Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  BlocListener<AppFunctionsCubit, AppFunctionsState>(
                    listener: (context, state) {
                      ...
                      if (state is ResourceDeletionFailed) {
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (context) => EventBloc()..add(GetUserResources()),
        ),
        BlocProvider(
          create: (context) => AppFunctionsCubit(),
        ),
                ...
                child: Column(
                  ...
                  children: [
                          ...
                          Expanded(
                            child: TextFormField(
                              ...
                              onFieldSubmitted: (value) {
                                BlocProvider.of<EventBloc>(context)
                                    .add(SearchUserResource(query: value));
                              },
                    ...
                    BlocListener<EventBloc, EventState>(
                      listener: (context, state) {
                        if (state is SearchUserResourceFailure) {
                          Timer(
                      ...
                      child: BlocBuilder<EventBloc, EventState>(
                        builder: (context, state) {
                          if (state is SearchUserResourceLoading) {
                            return SizedBox(
                              height: height * 0.65,
                              child: const Center(
                                child: LoadingCircle(),
                          ...
                          } else if (state is SearchUserResourceSuccess) {
                            return Column(
                              children: [
                                Row(
                                  mainAxisAlignment:
                            ...
                            return BlocListener<EventBloc, EventState>(
                              listener: (context, state) {
                                if (state is UserResourceFailure) {
                                  Timer(
                                    const Duration(milliseconds: 300),
                              ...
                              child: BlocBuilder<EventBloc, EventState>(
                                builder: (context, state) {
                                  if (state is UserResourceLoading) {
                                    return SizedBox(
                                        height: height * 0.65,
                                        child: const Center(
                                            child: LoadingCircle()));
                                  } else if (state is UserResourceSuccess) {
                                    return Padding(
